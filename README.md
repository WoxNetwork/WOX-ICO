...
|Whitelist    |:heavy_check_mark:| :x:              |:heavy_check_mark:| :x:              | :x:              | :x:              | :x:              | :x:              |
|purchase     | :x:              | Private          | :x:              | Public           | Public           | Public           | Public           | :x:              |
|Granting     | :x:              | :x:              |:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:| :x:              |
|Referral     | :x:              |:heavy_check_mark:| :x:              |:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:| :x:              |
|Burning      |:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|
|Finalization | :x:              | :x:              | :x:              | :x:              | :x:              | :x:              | :x:              |:heavy_check_mark:|
|Refunding    | :x:              | :x:              | :x:              | :x:              | :x:              | :x:              | :x:              |:heavy_check_mark:|
|Withdrawal   |:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|:heavy_check_mark:|      
